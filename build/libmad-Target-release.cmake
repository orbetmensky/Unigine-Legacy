...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET libmad::libmad
                 ...
                 $<$<CONFIG:Release>:${libmad_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET libmad::libmad
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${libmad_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET libmad::libmad
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${libmad_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET libmad::libmad
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${libmad_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET libmad::libmad
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${libmad_COMPILE_OPTIONS_RELEASE}> APPEND)
